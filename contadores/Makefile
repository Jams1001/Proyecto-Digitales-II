r: testbench.v tester.v contadores.v
	iverilog -o salida testbench.v
	vvp salida
	gtkwave contadores.vcd
	rm -rf salida
t:
...
s1:	synthesis_contadores.ys
	yosys -s synthesis_contadores.ys
	sed -i 's/module contadores/module contadoresS/' contadoresS.v